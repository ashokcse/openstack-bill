...
urlpatterns += patterns('django_openstack.syspanel.views.bills',
    url(r'^usage/(?P<tenant_id>[^/]+)$', 'tenant_usage', name='syspanel_tenant_usage'),    
    url(r'^bills/$', 'index', name='syspanel_bills'),
    url(r'^bills/refresh$', 'refresh', name='syspanel_bills_refresh'),    
    url(r'^bills/create$', 'create', name='syspanel_bills_create'),
)
