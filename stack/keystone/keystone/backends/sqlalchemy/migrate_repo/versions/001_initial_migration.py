...
#billunit
biller = {}
biller['id'] = sqlalchemy.Column('id', sqlalchemy.Integer, primary_key=True, autoincrement=True)
biller['vcpu'] = sqlalchemy.Column('vcpu', sqlalchemy.Integer)
biller['ram'] = sqlalchemy.Column('ram', sqlalchemy.Integer)
biller['vdisk'] = sqlalchemy.Column('vdisk', sqlalchemy.Integer)
biller['enabled'] = sqlalchemy.Column('enabled',sqlalchemy.Boolean)
billunit = sqlalchemy.Table('billunit', meta, *biller.values())


#InstanceBills
instance_bill = {}
instance_bill['id'] = sqlalchemy.Column('id', sqlalchemy.Integer, primary_key=True, autoincrement=True)
instance_bill['total_vcpu'] = sqlalchemy.Column('total_vcpu', sqlalchemy.Integer)
instance_bill['total_ram'] = sqlalchemy.Column('total_ram', sqlalchemy.Integer)
instance_bill['vdisk'] = sqlalchemy.Column('vdisk', sqlalchemy.Integer)
instance_bill['enabled'] = sqlalchemy.Column('enabled',sqlalchemy.Boolean)
instance_bills = sqlalchemy.Table('instance_bills', meta, *instance_bill.values())


#UserBills

user_bill = {}
user_bill['id'] = sqlalchemy.Column('id', sqlalchemy.Integer, primary_key=True, autoincrement=True)
user_bill['vcpu'] = sqlalchemy.Column('vcpu', sqlalchemy.Integer)
user_bill['ram'] = sqlalchemy.Column('ram', sqlalchemy.Integer)
user_bill['vdisk'] = sqlalchemy.Column('vdisk', sqlalchemy.Integer)
user_bill['enabled'] = sqlalchemy.Column('enabled',sqlalchemy.Boolean)
user_bills= sqlalchemy.Table('user_bills', meta, *user_bill.values())
sqlalchemy.ForeignKeyConstraint(
        [user_bill['id']],
        [user['id']])
